# =============================================================================
# AccessWeaver Production Environment - Variables
# =============================================================================
...
variable "rds_instance_class" {
  ...
  type        = string
  default     = "db.m5.large"  # Upgraded for production
}

variable "rds_allocated_storage" {
  description = "Allocated storage for RDS in GB"
  type        = number
  default     = 100  # Increased for production
}
...
variable "redis_node_type" {
  ...
  type        = string
  default     = "cache.m5.large"  # Upgraded for production
}
...
variable "enable_enhanced_backups" {
  description = "Enable enhanced backup strategy"
  type        = bool
  default     = true
}
